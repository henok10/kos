        ...
        <Box sx={styles.container}>
          ...
          <Box component={"main"} sx={styles.mainSection}>
            <Routes>
              ...
              <Route
                path="/listingsOwner/:id"
                element={<ListingOwnerDetail />}
              />
              <Route path="/datakos" element={<DataTable />} />
              <Route
                path="/datakosApprove/:id"
                element={<DataTableApprove />}
              />
...
const styles = {
  container: {
    display: "flex",
    height: "100vh", // Use 100vh to ensure it covers the entire viewport height
  },
  mainSection: {
