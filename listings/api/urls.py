...
urlpatterns = [
    ...
    path('transaction/<int:pk>/delete/',
     ...
     path('fasilitas-kamar/<int:pk>/update', listings_api_views.FasilitasKamarUpdate.as_view()),
     path('fasilitas-rumah/<int:pk>/update', listings_api_views.FasilitasRumahUpdate.as_view()),
