...
from appUsers.models import Customer, Owner, User
User = get_user_model()
...
class Kamar(models.Model):
    rumah = models.ForeignKey(
        Rumah, on_delete=models.CASCADE, blank=True, null=True, related_name='kamar')
...
class Review(models.Model):
    rumah = models.ForeignKey(
        Rumah, on_delete=models.CASCADE, blank=True, null=True, related_name='review')
...
class FasilitasKamar(models.Model):
    kamar = models.ForeignKey(Kamar, on_delete=models.CASCADE,
                              blank=True, null=True, related_name='fasilitaskamar')
...
class FasilitasRumah(models.Model):
    rumah = models.ForeignKey(Rumah, on_delete=models.CASCADE,
                              blank=True, null=True, related_name='fasilitasrumah')
