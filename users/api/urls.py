...
urlpatterns=[
    ...
    path('profiles/customer/<int:customer>/update/', users_api_views.CustomerUpdate.as_view()),
    path('profiles/customer/<int:customer>/', users_api_views.CustomerDetail.as_view()),
